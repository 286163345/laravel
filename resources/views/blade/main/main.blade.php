...
<head>
    ...
    <link href="{{ URL::asset('home/font-awesome/css/font-awesome.css') }}" rel="stylesheet">

    <!-- Toastr style -->
    <link href="{{ url::asset('home/css/plugins/toastr/toastr.min.css') }}" rel="stylesheet">

    <!-- Gritter -->
    <link href="{{ url::asset('home/js/plugins/gritter/jquery.gritter.css') }}" rel="stylesheet">
...
<body>
    <div id="wrapper">
        @include('blade.main.left_menu')
        <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="row border-bottom">
        @include('blade.main.top_nav')
        </div>
        @include('blade.main.navigation')
    ...
    <!-- Mainly scripts -->
    <script src="{{ url::asset('home/js/jquery-3.1.1.min.js') }}"></script>
    <script src="{{ url::asset('home/js/popper.min.js') }}"></script>
    <script src="{{ url::asset('home/js/bootstrap.js') }}"></script>
    <script src="{{ url::asset('home/js/plugins/metisMenu/jquery.metisMenu.js') }}"></script>
    <script src="{{ url::asset('home/js/plugins/slimscroll/jquery.slimscroll.min.js') }}"></script>

    <!-- Flot -->
    <script src="{{ url::asset('home/js/plugins/flot/jquery.flot.js') }}"></script>
    <script src="{{ url::asset('home/js/plugins/flot/jquery.flot.tooltip.min.js') }}"></script>
    <script src="{{ url::asset('home/js/plugins/flot/jquery.flot.spline.js') }}"></script>
    <script src="{{ url::asset('home/js/plugins/flot/jquery.flot.resize.js') }}"></script>
    <script src="{{ url::asset('home/js/plugins/flot/jquery.flot.pie.js') }}"></script>

    <!-- Peity -->
    <script src="{{ url::asset('home/js/plugins/peity/jquery.peity.min.js') }}"></script>
    <script src="{{ url::asset('home/js/demo/peity-demo.js') }}"></script>

    <!-- Custom and plugin javascript -->
    <script src="{{ url::asset('home/js/inspinia.js') }}"></script>
    <script src="{{ url::asset('home/js/plugins/pace/pace.min.js') }}"></script>

    <!-- jQuery UI -->
    <script src="{{ url::asset('home/js/plugins/jquery-ui/jquery-ui.min.js') }}"></script>

    <!-- GITTER -->
    <script src="{{ url::asset('home/js/plugins/gritter/jquery.gritter.min.js') }}"></script>

    <!-- Sparkline -->
    <script src="{{ url::asset('home/js/plugins/sparkline/jquery.sparkline.min.js') }}"></script>

    <!-- Sparkline demo data  -->
    <script src="{{ url::asset('home/js/demo/sparkline-demo.js') }}"></script>

    <!-- ChartJS-->
    <script src="{{ url::asset('home/js/plugins/chartJs/Chart.min.js') }}"></script>
